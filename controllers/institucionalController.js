...
const termos = {
    ...
    cookies:{
        ...
        paragrafos:[
            ...
            "8.1.1. Atualmente, a LYXUS utiliza o Google Analytics (analytics/estatísticas de navegação) e o tawk.to (chat de atendimento exibido no site), ambos ferramentas de terceiros que podem gravar cookies próprios no dispositivo do usuário. O carregamento de ambos depende do consentimento manifestado no banner de cookies, exceto quando o próprio usuário iniciar uma conversa pelo chat.",
